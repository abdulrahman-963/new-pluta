...
@Service
public class PythonScriptExecutor_old {

    private static final Logger logger = LoggerFactory.getLogger(PythonScriptExecutor_old.class);
    ...
    public PythonAnalysisResult executeAnalysis(String imagePath, Double confidenceThreshold) throws Exception {
   ...
   /* @PostConstruct
    ...
    private PythonAnalysisResult parseAnalysisResult(String output) throws JsonProcessingException {
        ...
        return mapper.readValue(jsonString, PythonAnalysisResult.class);
    }
